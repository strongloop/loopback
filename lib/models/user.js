...
/**
 * Built-in User model. Extends LoopBack base [Model](#model-new-model).
 *
 * Default `User` ACLs.
 *
 * - DENY EVERYONE `*`
 ...
 * @property {String} from Sender email addresss, for example 'noreply@myapp.com'.
 * @property {String} subject Subject line text.
 * @property {String} text Text of email.
 * @property {String} template Name of template that displays verification page, for example, 'verify.ejs'.
 * @property {String} redirect Page to which user will be redirected after they verify their email, for example '/' for root URI.
 */
