 ...
 * @param {Function} cb Callback function with `cb(err, obj)` signature, where `err` is error functionand `obj` is null or Model instance.
 */
 ...
 */ 
PersistedModel.remove = destroyAll;

/**
 * Alias for `destroyAll`
 */ 
PersistedModel.deleteAll = destroyAll;
 ...
 * Equvialent to `updateAttributes({name: 'value'}, cb)`
 *
