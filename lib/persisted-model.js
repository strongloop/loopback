...
module.exports = function(registry) {
  ...
  PersistedModel.enableChangeTracking = function() {
    ...
    Model.observe('after save', PersistedModel.rectifyOnSave.bind(PersistedModel));

    Model.observe('after delete', PersistedModel.rectifyOnDelete.bind(PersistedModel));
